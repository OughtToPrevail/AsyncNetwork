...
public enum DisconnectionType
{
	 ...
	 * oughttoprevail.asyncnetwork.impl.util.Validator#handleRemoteHostCloseException(IOException, Channel)} finds it as a remote close exception.
	 */
	REMOTE_CLOSE_BY_EXCEPTION,
	/**
	 * The exception close {@link DisconnectionType} is used when an exception occurs. Also {@link
	 * Channel#onException(Consumer)} consumer will be called.
	 */
	EXCEPTION_CLOSE,}