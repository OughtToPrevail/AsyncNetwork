...
public class ReadResultImpl implements ReadResult
{
	...
	public ReadResultImpl(Channel<?> channel, Deque<Object> results)
	{
	...
	void add(Object obj)
	{
		synchronized(results)
		{
			...
			results.add(obj);
			if(results.size() == runnableRequestSize)
			{
				runnable.run();
	...
	/**
	 * Casts the specified obj to T, if the obj is {@link NullElement} then
	 * {@code null} is returned, else it is {@code (T) obj}.
	 *
	...
	private static class NullElement
	{
