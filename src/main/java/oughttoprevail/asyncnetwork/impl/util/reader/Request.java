...
class Request
{
	...
	Request(Consumer<ByteBuffer> request, int requestLength, boolean always)
	{
	...
	/**
	 * Whether this request should stay after finished.
	 *
	 * @return whether this request should stay after finished
	 */
	boolean isAlways()
	{
		return always;
