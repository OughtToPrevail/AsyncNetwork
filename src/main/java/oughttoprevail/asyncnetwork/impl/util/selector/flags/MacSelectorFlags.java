...
public abstract class MacSelectorFlags<S extends IServerClient> extends SelectorFlagsImpl<S>
{
	private static final int MAC_READ = -1;
	private static final int MAC_WRITE = -2;
	
	public MacSelectorFlags(AbstractServer<?, S> server, IndexedList<S> clients)
	{
